...
- Enhanced has enough N and **fails** the same-book PF / PnL bar. An overlay
  must beat holdout **104 trades, PF 0.35, negative PnL** on this book — and
  still is not a promote path.
