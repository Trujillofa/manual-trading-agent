...
```bash
python -m research.new_edge.term_structure.data.verify_term_structure_data --sample-archive /tmp/cme.20250912.s.pa2.zip --sample-date 2025-09-12 --output docs/research/term_structure/CME_FREE_DATA_AUDIT_2026-06-30.md --provenance research/new_edge/term_structure/data/provenance/cme_free_data_audit_2026-06-30.json
```

## The settlement parser works
...
- Parser smoke: 533 settlements across 12/12 fixed-universe markets.

## The free source fails the Tier-A gate
...
Machine-readable provenance: `research/new_edge/term_structure/data/provenance/cme_free_data_audit_2026-06-30.json`
