...
def write_report(
    ...
    for v in ["V0", "V0_MA", "V2", "V2_MA"]:
        ...
        gw = sum(r.wins * (r.total_pnl_pct / r.trades if r.trades else 0) for r in grp if r.trades)
        gl = sum(r.losses * abs(r.total_pnl_pct / r.trades if r.trades else 0) for r in grp if r.trades)
